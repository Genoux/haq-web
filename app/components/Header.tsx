    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-40 w-full container h-screen px-0 lg:px-4 justify-center flex flex-col">
        <div className="flex flex-col gap-1 mb-8">
          <div className={clsx('flex flex-col items-start', process.env.NEXT_PUBLIC_STATE !== "tournament" ? "gap-6 items-start" : "gap-3 lg:items-start")}>
            <div className={clsx('flex flex-col items-center gap-1', process.env.NEXT_PUBLIC_STATE !== "tournament" ? "items-start" : "lg:items-start")}>
            ...
            {process.env.NEXT_PUBLIC_STATE === "tournament" && (
              <h2 className="text-5xl sm:text-6xl text-center lg:text-start font-black w-fit tracking-tight">
                15 JUIN - 18H
              </h2>
            )}
            <p className={clsx('text-center max-w-xl', process.env.NEXT_PUBLIC_STATE !== "tournament" ? "text-center text-lg text-white text-opacity-80" : "max-w-xl lg:text-start text-base text-white text-opacity-80")}>
