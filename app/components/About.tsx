    ...
    <>
      <div className="z-40 bg-black relative overflow-hidden pt-40 pb-96">
        ...
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-24 lg:gap-40'>
          <div>
          <Image className="border rounded w-64  md:w-96 lg:w-full lg:h-auto" width={400} height={400} src="/images/league.svg" alt="Tournois HAQ" priority={false} />
          </div>
          <div>
            ...
            <div className='flex flex-col gap-5 text-2xl lg:text-3xl font-bold leading-[1:1] tracking-tight max-w-3xl'>
              <p >Premier tournoi d’Aram au Québec.
                <br></br>
                <span className='text-gray'>Le même mode de jeu, mais revisité pour vous offrir une expérience plus compétitive.</span>
              </p>
              ...
              <div className='w-fit'>
                <Link target='_blank' href={'https://reglements.tournoishaq.ca'}><Button variant="outline" className='mt-4' size={"lg"}>Règlements</Button></Link>
              </div>
            </div>
          </div>
        </div>
